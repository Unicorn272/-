...
st.info("산업 정의는 분석가의 판단에 의존합니다. Peer group 구성은 만드는 사람마다 달라질 수 있으며, GICS 같은 제3자 분류체계를 활용하되 경계 사례는 추가 판단이 필요합니다.")
st.divider()
...
🚫 **오류** — DART 매칭 실패 / 데이터 없음

---
매출 비중 데이터가 없으면 사업부문·제품명 키워드로 판단하며 신뢰도 **낮음**으로 표시됩니다.
""")
